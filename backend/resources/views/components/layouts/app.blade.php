...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen flex antialiased">
    ...
    <div class="flex-grow flex flex-col min-h-screen overflow-x-hidden min-w-0">
        ...
        <main class="flex-grow p-4 md:p-6 lg:p-8">
            ...
            @if($errors->any())
                <div class="mb-6 p-4 rounded-xl bg-danger/20 border border-danger/30 text-danger shadow-lg backdrop-blur-sm">
                    <div class="flex items-center mb-1">
                        <span class="mr-2">❌</span>
                        <span class="text-sm font-bold">Please correct the following errors:</span>
                    </div>
                    <ul class="list-disc pl-6 text-xs font-semibold space-y-0.5">
