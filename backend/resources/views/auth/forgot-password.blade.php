...
<head>
    ...
    <title>HumaNode HRMS - Forgot Password</title>
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Enter your email address to receive a link to recover your credentials.</p>
        ...
        <a href="#" class="footer-link">Back to Sign In</a>
    </div>
</body>
</html>
